...
# if(computer == 'acer'){ cloud_dir='/Users/egora/Dropbox/' }
...
## Data input
ds = read.csv(paste(cloud_dir, 'Projects/eb/eb/an/consolidated/ds1.csv', sep='/'))
dsa = read.csv(paste(cloud_dir, 'Projects/eb/eb/an/consolidated/dsa1.csv', sep='/'))
