...
source('C:/gd/Prog/R/myFunctions/pvalfn.R')
ds = read.csv(paste(prog_dir, 'eb/an/consolidated/ds4.csv', sep=''))
dsa = read.csv(paste(prog_dir, 'eb/an/consolidated/dsa4.csv', sep=''))
