...
excl_long = ds[ds$rt>long_rt_cutoff, c('subj', 'cond', 'sess', 'trial')]
if(nrow(excl_long) > 0){  # if there are any trials to exclude based on the long RTs
  colnames(excl_long)[4] = 'trial'  # renaming the 'trial_id' column to 'trial'
