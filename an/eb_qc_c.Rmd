---
title: "[eb1] Condition: Control - Quality Control"
author: "Egor Ananyev"
date: "2019-01-09"
output:
    html_document:
...
ylims = c(0, 1000)
for(cur_trial in 1:nrow(df_trials)){
    p = ggplot(df_samples[df_samples$trial==cur_trial,], aes(x=sample))
...
write.table(trials_to_exclude, paste(this_data_dir, 'exclude.csv', sep='/'),
