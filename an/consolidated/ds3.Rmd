...
# if(computer=='shocky' || computer=='acer' || computer == 'toshi'){ cloud_dir='C:/gd/' }
if(computer=='station3'){ cloud_dir='/home/station3/Desktop/Egor/Dropbox/' }
all_data_dir = paste0(cloud_dir, 'Projects/eb/data/eb3/')
...
# Data output
```{r}
write.csv(ds, 'ds3.csv', row.names=F)
write.csv(dsa, 'dsa3.csv', row.names=F)
```