...
```{r}
ds1 = ds1[ds1$cue_pred == 1,]  # only including predictive cues
summary(ds1$ctoa)
ds1$targ_bin = NA
ds1$targ_bin[ds1$ctoa < 700] = 'Early'
...
ds2$targ_bin = NA
ds2$targ_bin[ds2$ctoa < 800] = 'Early'
ds2$targ_bin[ds2$ctoa > 850 & ds2$ctoa < 950] = 'Middle'
ds2$targ_bin[ds2$ctoa > 1150 & ds2$ctoa < 1250] = 'Late'
...
p = plot_themefy(p)
plot(p)
pdf('eb_all_adv.pdf', width=7.5, height=3.5)
plot(p)
dev.off()
```